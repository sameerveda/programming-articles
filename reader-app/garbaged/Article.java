...
import static sam.article.reader.model.ArticleMeta.ADDEDON;
import static sam.article.reader.model.ArticleMeta.DATA_TABLE_NAME;
import static sam.article.reader.model.ArticleMeta.FAVICON;
import static sam.article.reader.model.ArticleMeta.ID;
import static sam.article.reader.model.ArticleMeta.NOTES;
import static sam.article.reader.model.ArticleMeta.REDIRECT;
import static sam.article.reader.model.ArticleMeta.SOURCE;
import static sam.article.reader.model.ArticleMeta.STATUS;
import static sam.article.reader.model.ArticleMeta.TAGS;
import static sam.article.reader.model.ArticleMeta.TITLE;
import static sam.article.reader.model.ArticleMeta.UPDATEDON;
import static sam.article.reader.model.ArticleMeta.VERSION;
...
import sam.dblist.viewer.FullViewItem;
import sam.sql.QueryUtils;

public class Article implements FullViewItem {
